...
@EnableAsync
@EnableScheduling
@EntityScan(basePackages = "com.ead.configserver")
@ComponentScan(basePackages = {"com.ead.configserver.*"})
@EnableJpaRepositories(basePackages = {"com.ead.configserver.repositories"})
